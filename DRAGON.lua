...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE INFO.LUA \e[0m"
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑   ┉ ┉ ┉ ┉≫ٴ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
if tonumber(user_id) == tonumber(1743400212) then  
var = 'المالك السورس'
elseif tonumber(user_id) == tonumber(1907021807) then
var =  ' مبرمج ايكا '
elseif tonumber(user_id) == tonumber(1899917202) then
var =  ' مبرمج اكسيفور '
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝐒𝐎𝐔𝐑𝐂𝐄𝐓𝐄𝐗𝐄𝐒 𐇑  ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/S0DRG)➤ ')
end
